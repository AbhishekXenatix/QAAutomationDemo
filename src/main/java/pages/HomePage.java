...
public class HomePage {
    ...
    private By contactUs = By.xpath("//*[@class='list-inline']/li[1]/a");
    ...
    public void clickOnTelephoneIcon() {
        ElementActions.clickElement(contactUs);
    }
    ...
    public void clickonDesiredCurrency(String currency) {
        ElementActions.clickElement(By.cssSelector("button[name='" + currency + "']"));
    }
    ...
    public void assertDirectedToRegisterPage() throws InterruptedException {
    ...
    public void assertdirectedtoproductdeatailspage(String productpage) {
        Validations.validatePageTitle(productpage);
    }
}

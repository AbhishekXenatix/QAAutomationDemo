...
public class RegisterPage {
    ...
    public void registerNewAcount(String firstname, String lastname, String email, String telephone, String password, String confirmPassword) throws InterruptedException {
    ...
    public void validateUnsuccessfulRegistry() throws InterruptedException {
        Assert.assertTrue(ElementActions.findElement(By.className("text-danger")).isDisplayed());
        Thread.sleep(3000);
    }
